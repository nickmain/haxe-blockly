...
var Er=function(a,b){var c=0,d="";b.STATEMENT_PREFIX&&(d+=b.injectId(b.STATEMENT_PREFIX,a));do{var e=b.valueToCode(a,"IF"+c,U.NONE)||"False";var f=b.statementToCode(a,"DO"+c)||b.PASS;b.STATEMENT_SUFFIX&&(f=b.prefixLines(b.injectId(b.STATEMENT_SUFFIX,a),b.INDENT)+f);d+=(c===0?"if ":"elif ")+e+":\n"+f;c++}while(a.getInput("IF"+c));if(a.getInput("ELSE")||b.STATEMENT_SUFFIX)f=a.getInput("ELSE")?b.statementToCode(a,"ELSE")||b.PASS:b.PASS,b.STATEMENT_SUFFIX&&(f=b.prefixLines(b.injectId(b.STATEMENT_SUFFIX,
a),b.INDENT)+f),d+="else:\n"+f;return d},Fr=function(a,b){var c=a.getField("TIMES")?String(parseInt(a.getFieldValue("TIMES"),10)):b.valueToCode(a,"TIMES",U.NONE)||"0";c=$.yf(c)?parseInt(c,10):"int("+c+")";var d=b.statementToCode(a,"DO");d=b.addLoopTrap(d,a)||b.PASS;return"for "+b.nameDB_.getDistinctName("count",$.P.VARIABLE)+" in range("+c+"):\n"+d},Gr=function(a,b){var c=a.getFieldValue("OP");if(c==="NEG"){var d=b.valueToCode(a,"NUM",U.UNARY_SIGN)||"0";return["-"+d,U.UNARY_SIGN]}b.definitions_.import_math=
...
"math.sin("+a+" / 180.0 * math.pi)";break;case "COS":d="math.cos("+a+" / 180.0 * math.pi)";break;case "TAN":d="math.tan("+a+" / 180.0 * math.pi)"}if(d)return[d,U.FUNCTION_CALL];switch(c){case "ASIN":d="math.asin("+a+") / math.pi * 180";break;case "ACOS":d="math.acos("+a+") / math.pi * 180";break;case "ATAN":d="math.atan("+a+") / math.pi * 180";break;default:throw Error("Unknown math operator: "+c);}return[d,U.MULTIPLICATIVE]},Hr=function(a,b){var c=[],d=a.workspace,e=$.Bd(d)||[];for(var f of e)e=
...
"";a.getInput("STACK")&&(g=b.statementToCode(a,"STACK"));var h="";a.getInput("RETURN")&&(h=b.valueToCode(a,"RETURN",U.NONE)||"");var m="";g&&h&&(m=f);h?h=b.INDENT+"return "+h+"\n":g||(g=b.PASS);var z=[],E=a.getVarModels();for(let H=0;H<E.length;H++)z[H]=b.getVariableName(E[H].getId());d="def "+c+"("+z.join(", ")+"):\n"+d+f+e+g+m+h;d=b.scrub_(a,d);b.definitions_["%"+c]=d;return null},Jr=function(a){return Ir.test(a)?[a,U.ATOMIC]:["str("+a+")",U.FUNCTION_CALL]},Kr=function(a,b){var c=b.provideFunction_("text_prompt",
`
def ${b.FUNCTION_NAME_PLACEHOLDER_}(msg):
  try:
    ...
    return input(msg)
`);b=a.getField("TEXT")?b.quote_(a.getFieldValue("TEXT")):b.valueToCode(a,"TEXT",U.NONE)||"''";c=c+"("+b+")";a.getFieldValue("TYPE")==="NUMBER"&&(c="float("+c+")");return[c,U.FUNCTION_CALL]},Lr=function(a,b){return[b.getVariableName(a.getFieldValue("VAR")),U.ATOMIC]},Mr=function(a,b){var c=b.valueToCode(a,"VALUE",U.NONE)||"0";return b.getVariableName(a.getFieldValue("VAR"))+" = "+c+"\n"},U,Nr=U||(U={});Nr[Nr.ATOMIC=0]="ATOMIC";Nr[Nr.COLLECTION=1]="COLLECTION";Nr[Nr.STRING_CONVERSION=1]="STRING_CONVERSION";
Nr[Nr.MEMBER=2.1]="MEMBER";Nr[Nr.FUNCTION_CALL=2.2]="FUNCTION_CALL";Nr[Nr.EXPONENTIATION=3]="EXPONENTIATION";Nr[Nr.UNARY_SIGN=4]="UNARY_SIGN";Nr[Nr.BITWISE_NOT=4]="BITWISE_NOT";Nr[Nr.MULTIPLICATIVE=5]="MULTIPLICATIVE";Nr[Nr.ADDITIVE=6]="ADDITIVE";Nr[Nr.BITWISE_SHIFT=7]="BITWISE_SHIFT";Nr[Nr.BITWISE_AND=8]="BITWISE_AND";Nr[Nr.BITWISE_XOR=9]="BITWISE_XOR";Nr[Nr.BITWISE_OR=10]="BITWISE_OR";Nr[Nr.RELATIONAL=11]="RELATIONAL";Nr[Nr.LOGICAL_NOT=12]="LOGICAL_NOT";Nr[Nr.LOGICAL_AND=13]="LOGICAL_AND";
Nr[Nr.LOGICAL_OR=14]="LOGICAL_OR";Nr[Nr.CONDITIONAL=15]="CONDITIONAL";Nr[Nr.LAMBDA=16]="LAMBDA";Nr[Nr.NONE=99]="NONE";
var Or=class extends $.Rp{constructor(a="Python"){super(a);this.ORDER_OVERRIDES=[[U.FUNCTION_CALL,U.MEMBER],[U.FUNCTION_CALL,U.FUNCTION_CALL],[U.MEMBER,U.MEMBER],[U.MEMBER,U.FUNCTION_CALL],[U.LOGICAL_NOT,U.LOGICAL_NOT],[U.LOGICAL_AND,U.LOGICAL_AND],[U.LOGICAL_OR,U.LOGICAL_OR]];this.PASS="";this.isInitialized=!1;for(let b in U)a=U[b],typeof a!=="string"&&(this["ORDER_"+b]=a);this.addReservedWords("False,None,True,and,as,assert,break,class,continue,def,del,elif,else,except,exec,finally,for,from,global,if,import,in,is,lambda,nonlocal,not,or,pass,print,raise,return,try,while,with,yield,NotImplemented,Ellipsis,__debug__,quit,exit,copyright,license,credits,ArithmeticError,AssertionError,AttributeError,BaseException,BlockingIOError,BrokenPipeError,BufferError,BytesWarning,ChildProcessError,ConnectionAbortedError,ConnectionError,ConnectionRefusedError,ConnectionResetError,DeprecationWarning,EOFError,Ellipsis,EnvironmentError,Exception,FileExistsError,FileNotFoundError,FloatingPointError,FutureWarning,GeneratorExit,IOError,ImportError,ImportWarning,IndentationError,IndexError,InterruptedError,IsADirectoryError,KeyError,KeyboardInterrupt,LookupError,MemoryError,ModuleNotFoundError,NameError,NotADirectoryError,NotImplemented,NotImplementedError,OSError,OverflowError,PendingDeprecationWarning,PermissionError,ProcessLookupError,RecursionError,ReferenceError,ResourceWarning,RuntimeError,RuntimeWarning,StandardError,StopAsyncIteration,StopIteration,SyntaxError,SyntaxWarning,SystemError,SystemExit,TabError,TimeoutError,TypeError,UnboundLocalError,UnicodeDecodeError,UnicodeEncodeError,UnicodeError,UnicodeTranslateError,UnicodeWarning,UserWarning,ValueError,Warning,ZeroDivisionError,_,__build_class__,__debug__,__doc__,__import__,__loader__,__name__,__package__,__spec__,abs,all,any,apply,ascii,basestring,bin,bool,buffer,bytearray,bytes,callable,chr,classmethod,cmp,coerce,compile,complex,copyright,credits,delattr,dict,dir,divmod,enumerate,eval,exec,execfile,exit,file,filter,float,format,frozenset,getattr,globals,hasattr,hash,help,hex,id,input,int,intern,isinstance,issubclass,iter,len,license,list,locals,long,map,max,memoryview,min,next,object,oct,open,ord,pow,print,property,quit,range,raw_input,reduce,reload,repr,reversed,round,set,setattr,slice,sorted,staticmethod,str,sum,super,tuple,type,unichr,unicode,vars,xrange,zip")}init(a){super.init(a);this.PASS=
this.INDENT+"pass\n";this.nameDB_?this.nameDB_.reset():this.nameDB_=new $.jj(this.RESERVED_WORDS_);this.nameDB_.setVariableMap(a.getVariableMap());this.nameDB_.populateVariables(a);this.nameDB_.populateProcedures(a);var b=[],c=$.Cd(a);for(let d=0;d<c.length;d++)b.push(this.nameDB_.getName(c[d],$.jj.DEVELOPER_VARIABLE_TYPE)+" = None");a=$.Bd(a);for(c=0;c<a.length;c++)b.push(this.getVariableName(a[c].getId())+" = None");this.definitions_.variables=b.join("\n");this.isInitialized=!0}finish(a){var b=
...
b,c=!1){var d="";if(!a.outputConnection||!a.outputConnection.targetConnection){var e=a.getCommentText();e&&(e=$.xf(e,this.COMMENT_WRAP-3),d+=this.prefixLines(e+"\n","# "));for(let f=0;f<a.inputList.length;f++)a.inputList[f].type===$.ie.VALUE&&(e=a.inputList[f].connection.targetBlock())&&(e=this.allNestedComments(e))&&(d+=this.prefixLines(e,"# "))}a=a.nextConnection&&a.nextConnection.targetBlock();c=c?"":this.blockToCode(a);return d+b+c}getAdjustedInt(a,b,c=0,d=!1){a.workspace.options.oneBasedIndex&&
c--;var e=a.workspace.options.oneBasedIndex?"1":"0";a=this.valueToCode(a,b,c?U.ADDITIVE:U.NONE)||e;$.yf(a)?(a=parseInt(a,10)+c,d&&(a=-a)):(a=c>0?"int("+a+" + "+c+")":c<0?"int("+a+" - "+-c+")":"int("+a+")",d&&(a="-"+a));return a}};var Pr={};Pr.controls_if=Er;Pr.controls_ifelse=Er;Pr.logic_boolean=function(a){return[a.getFieldValue("BOOL")==="TRUE"?"True":"False",U.ATOMIC]};Pr.logic_compare=function(a,b){var c={EQ:"==",NEQ:"!=",LT:"<",LTE:"<=",GT:">",GTE:">="}[a.getFieldValue("OP")],d=U.RELATIONAL,e=b.valueToCode(a,"A",d)||"0";a=b.valueToCode(a,"B",d)||"0";return[e+" "+c+" "+a,d]};Pr.logic_negate=function(a,b){return["not "+(b.valueToCode(a,"BOOL",U.LOGICAL_NOT)||"True"),U.LOGICAL_NOT]};
Pr.logic_null=function(){return["None",U.ATOMIC]};Pr.logic_operation=function(a,b){var c=a.getFieldValue("OP")==="AND"?"and":"or",d=c==="and"?U.LOGICAL_AND:U.LOGICAL_OR,e=b.valueToCode(a,"A",d);a=b.valueToCode(a,"B",d);e||a?(b=c==="and"?"True":"False",e||(e=b),a||(a=b)):a=e="False";return[e+" "+c+" "+a,d]};
Pr.logic_ternary=function(a,b){var c=b.valueToCode(a,"IF",U.CONDITIONAL)||"False",d=b.valueToCode(a,"THEN",U.CONDITIONAL)||"None";a=b.valueToCode(a,"ELSE",U.CONDITIONAL)||"None";return[d+" if "+c+" else "+a,U.CONDITIONAL]};var Qr={controls_flow_statements:function(a,b){var c="";b.STATEMENT_PREFIX&&(c+=b.injectId(b.STATEMENT_PREFIX,a));b.STATEMENT_SUFFIX&&(c+=b.injectId(b.STATEMENT_SUFFIX,a));if(b.STATEMENT_PREFIX){let d=a.getSurroundLoop();d&&!d.suppressPrefixSuffix&&(c+=b.injectId(b.STATEMENT_PREFIX,d))}switch(a.getFieldValue("FLOW")){case "BREAK":return c+"break\n";case "CONTINUE":return c+"continue\n"}throw Error("Unknown flow statement.");},controls_for:function(a,b){function c(){return b.provideFunction_("downRange",
`
...
def ${b.FUNCTION_NAME_PLACEHOLDER_}(start, stop, step):
  while start <= stop:
    yield start
    start += abs(step)
`)}var e=b.getVariableName(a.getFieldValue("VAR")),f=b.valueToCode(a,"FROM",U.NONE)||"0",g=b.valueToCode(a,"TO",U.NONE)||"0",h=b.valueToCode(a,"BY",U.NONE)||"1",m=b.statementToCode(a,"DO");m=b.addLoopTrap(m,a)||b.PASS;var z="";$.yf(f)&&$.yf(g)&&$.yf(h)?(f=Number(f),g=Number(g),h=Math.abs(Number(h)),f%1===0&&g%1===0&&h%1===0?(f<=g?(g++,a=f===0&&h===1?g:f+", "+g,h!==1&&(a+=", "+h)):(g--,a=f+", "+g+", -"+h),a="range("+a+")"):(a=f<g?d():c(),a+="("+f+", "+g+", "+h+")")):(a=function(E,H){$.yf(E)?E=String(Number(E)):
E.match(/^\w+$/)||(H=b.nameDB_.getDistinctName(e+H,$.P.VARIABLE),z+=H+" = "+E+"\n",E=H);return E},f=a(f,"_start"),g=a(g,"_end"),h=a(h,"_inc"),typeof f==="number"&&typeof g==="number"?(a=f<g?d():c(),a+="("+f+", "+g+", "+h+")"):a="("+f+" <= "+g+") and "+d()+"("+f+", "+g+", "+h+") or "+c()+"("+f+", "+g+", "+h+")");return z+="for "+e+" in "+a+":\n"+m},controls_forEach:function(a,b){var c=b.getVariableName(a.getFieldValue("VAR")),d=b.valueToCode(a,"LIST",U.RELATIONAL)||"[]",e=b.statementToCode(a,"DO");
e=b.addLoopTrap(e,a)||b.PASS;return"for "+c+" in "+d+":\n"+e}};Qr.controls_repeat=Fr;Qr.controls_repeat_ext=Fr;Qr.controls_whileUntil=function(a,b){var c=a.getFieldValue("MODE")==="UNTIL",d=b.valueToCode(a,"BOOL",c?U.LOGICAL_NOT:U.NONE)||"False",e=b.statementToCode(a,"DO");e=b.addLoopTrap(e,a)||b.PASS;c&&(d="not "+d);return"while "+d+":\n"+e};var Rr={math_arithmetic:function(a,b){var c={ADD:[" + ",U.ADDITIVE],MINUS:[" - ",U.ADDITIVE],MULTIPLY:[" * ",U.MULTIPLICATIVE],DIVIDE:[" / ",U.MULTIPLICATIVE],POWER:[" ** ",U.EXPONENTIATION]}[a.getFieldValue("OP")],d=c[0];c=c[1];var e=b.valueToCode(a,"A",c)||"0";a=b.valueToCode(a,"B",c)||"0";return[e+d+a,c]},math_atan2:function(a,b){b.definitions_.import_math="import math";var c=b.valueToCode(a,"X",U.NONE)||"0";return["math.atan2("+(b.valueToCode(a,"Y",U.NONE)||"0")+", "+c+") / math.pi * 180",U.MULTIPLICATIVE]},
...
Rr.math_round=Gr;Rr.math_single=Gr;Rr.math_trig=Gr;var Sr={procedures_callnoreturn:function(a,b){return b.forBlock.procedures_callreturn(a,b)[0]+"\n"},procedures_callreturn:function(a,b){var c=b.getProcedureName(a.getFieldValue("NAME")),d=[],e=a.getVarModels();for(let f=0;f<e.length;f++)d[f]=b.valueToCode(a,"ARG"+f,U.NONE)||"None";return[c+"("+d.join(", ")+")",U.FUNCTION_CALL]}};Sr.procedures_defnoreturn=Hr;Sr.procedures_defreturn=Hr;
Sr.procedures_ifreturn=function(a,b){var c="if "+(b.valueToCode(a,"CONDITION",U.NONE)||"False")+":\n";b.STATEMENT_SUFFIX&&(c+=b.prefixLines(b.injectId(b.STATEMENT_SUFFIX,a),b.INDENT));a.hasReturnValue_?(a=b.valueToCode(a,"VALUE",U.NONE)||"None",c+=b.INDENT+"return "+a+"\n"):c+=b.INDENT+"return\n";return c};var Ir=/^\s*'([^']|\\')*'\s*$/,Tr={text:function(a,b){return[b.quote_(a.getFieldValue("TEXT")),U.ATOMIC]},text_append:function(a,b){var c=b.getVariableName(a.getFieldValue("VAR"));a=b.valueToCode(a,"TEXT",U.NONE)||"''";return c+" = str("+c+") + "+Jr(a)[0]+"\n"},text_changeCase:function(a,b){var c={UPPERCASE:".upper()",LOWERCASE:".lower()",TITLECASE:".title()"}[a.getFieldValue("CASE")];return[(b.valueToCode(a,"TEXT",U.MEMBER)||"''")+c,U.FUNCTION_CALL]},text_charAt:function(a,b){var c=a.getFieldValue("WHERE")||
...
"";break;default:throw Error("Unhandled option (text_getSubstring)");}switch(d){case "FROM_START":a=b.getAdjustedInt(a,"AT2",1);break;case "FROM_END":a=b.getAdjustedInt(a,"AT2",0,!0);$.yf(String(a))?a===0&&(a=""):(b.definitions_.import_sys="import sys",a+=" or sys.maxsize");break;case "LAST":a="";break;default:throw Error("Unhandled option (text_getSubstring)");}return[e+"["+c+" : "+a+"]",U.MEMBER]},text_indexOf:function(a,b){var c=a.getFieldValue("END")==="FIRST"?"find":"rfind",d=b.valueToCode(a,
"FIND",U.NONE)||"''";b=(b.valueToCode(a,"VALUE",U.MEMBER)||"''")+"."+c+"("+d+")";return a.workspace.options.oneBasedIndex?[b+" + 1",U.ADDITIVE]:[b,U.FUNCTION_CALL]},text_isEmpty:function(a,b){return["not len("+(b.valueToCode(a,"VALUE",U.NONE)||"''")+")",U.LOGICAL_NOT]},text_join:function(a,b){switch(a.itemCount_){case 0:return["''",U.ATOMIC];case 1:return a=b.valueToCode(a,"ADD0",U.NONE)||"''",Jr(a);case 2:var c=b.valueToCode(a,"ADD0",U.NONE)||"''";a=b.valueToCode(a,"ADD1",U.NONE)||"''";return[Jr(c)[0]+
" + "+Jr(a)[0],U.ADDITIVE];default:c=[];for(let d=0;d<a.itemCount_;d++)c[d]=b.valueToCode(a,"ADD"+d,U.NONE)||"''";a=b.nameDB_.getDistinctName("x",$.P.VARIABLE);return["''.join([str("+a+") for "+a+" in ["+c.join(", ")+"]])",U.FUNCTION_CALL]}},text_length:function(a,b){return["len("+(b.valueToCode(a,"VALUE",U.NONE)||"''")+")",U.FUNCTION_CALL]},text_print:function(a,b){return"print("+(b.valueToCode(a,"TEXT",U.NONE)||"''")+")\n"}};Tr.text_prompt=Kr;Tr.text_prompt_ext=Kr;
Tr.text_replace=function(a,b){var c=b.valueToCode(a,"TEXT",U.MEMBER)||"''",d=b.valueToCode(a,"FROM",U.NONE)||"''";a=b.valueToCode(a,"TO",U.NONE)||"''";return[c+".replace("+d+", "+a+")",U.MEMBER]};Tr.text_reverse=function(a,b){return[(b.valueToCode(a,"TEXT",U.MEMBER)||"''")+"[::-1]",U.MEMBER]};Tr.text_trim=function(a,b){var c={LEFT:".lstrip()",RIGHT:".rstrip()",BOTH:".strip()"}[a.getFieldValue("MODE")];return[(b.valueToCode(a,"TEXT",U.MEMBER)||"''")+c,U.FUNCTION_CALL]};var Ur={};Ur.variables_get=Lr;Ur.variables_set=Mr;var Vr={};Vr.variables_get_dynamic=Lr;Vr.variables_set_dynamic=Mr;var Wr=new Or;Wr.addReservedWords("math,random,Number");
...
b.getAdjustedInt(a,"AT2",1);break;case "FROM_END":a=b.getAdjustedInt(a,"AT2",0,!0);$.yf(String(a))?a===0&&(a=""):(b.definitions_.import_sys="import sys",a+=" or sys.maxsize");break;case "LAST":a="";break;default:throw Error("Unhandled option (lists_getSublist)");}return[c+"["+d+" : "+a+"]",U.MEMBER]},lists_indexOf:function(a,b){var c=b.valueToCode(a,"FIND",U.NONE)||"[]",d=b.valueToCode(a,"VALUE",U.NONE)||"''",e=" -1",f="",g=" - 1";a.workspace.options.oneBasedIndex&&(e=" 0",f=" + 1",g="");return[(a.getFieldValue("END")===
...
`)+"("+c+', "'+d+'", '+a+")",U.FUNCTION_CALL]},lists_split:function(a,b){var c=a.getFieldValue("MODE");if(c==="SPLIT")c=b.valueToCode(a,"INPUT",U.MEMBER)||"''",a=b.valueToCode(a,"DELIM",U.NONE),a=c+".split("+a+")";else if(c==="JOIN")c=b.valueToCode(a,"INPUT",U.NONE)||"[]",a=(b.valueToCode(a,"DELIM",U.MEMBER)||"''")+".join("+c+")";else throw Error("Unknown mode: "+c);return[a,U.FUNCTION_CALL]}},Pr,Qr,Rr,Sr,Tr,Ur,Vr);for(let a in Xr)Wr.forBlock[a]=Xr[a];var Yr={};Yr.Order=U;Yr.PythonGenerator=Or;
Yr.pythonGenerator=Wr;$.__chunk_python=Yr;
