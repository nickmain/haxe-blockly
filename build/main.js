...
var blockly_model_Toolbox = $hxEnums["blockly.model.Toolbox"] = { __ename__ : "blockly.model.Toolbox", __constructs__ : ["FlatToolbox","TreeToolbox"]
	,FlatToolbox: ($_=function(items) { return {_hx_index:0,items:items,__enum__:"blockly.model.Toolbox",toString:$estr}; },$_.__params__ = ["items"],$_)
	,TreeToolbox: ($_=function(items) { return {_hx_index:1,items:items,__enum__:"blockly.model.Toolbox",toString:$estr}; },$_.__params__ = ["items"],$_)
};
var blockly_model_Categories = $hxEnums["blockly.model.Categories"] = { __ename__ : "blockly.model.Categories", __constructs__ : ["Category","Separator"]
	,Category: ($_=function(name,colour,subcategories,blocks) { return {_hx_index:0,name:name,colour:colour,subcategories:subcategories,blocks:blocks,__enum__:"blockly.model.Categories",toString:$estr}; },$_.__params__ = ["name","colour","subcategories","blocks"],$_)
	,Separator: {_hx_index:1,__enum__:"blockly.model.Categories",toString:$estr}
};
var blockly_model_Blocks = $hxEnums["blockly.model.Blocks"] = { __ename__ : "blockly.model.Blocks", __constructs__ : ["Block","Button","Gap"]
	,Block: ($_=function(block) { return {_hx_index:0,block:block,__enum__:"blockly.model.Blocks",toString:$estr}; },$_.__params__ = ["block"],$_)
	,Button: ($_=function(text) { return {_hx_index:1,text:text,__enum__:"blockly.model.Blocks",toString:$estr}; },$_.__params__ = ["text"],$_)
	,Gap: ($_=function(gap) { return {_hx_index:2,gap:gap,__enum__:"blockly.model.Blocks",toString:$estr}; },$_.__params__ = ["gap"],$_)
};
var blockly_model_BlockModel = $hxEnums["blockly.model.BlockModel"] = { __ename__ : "blockly.model.BlockModel", __constructs__ : ["Block","BlockType","BlockMin"]
	,Block: ($_=function(type,id,disabled,collapsed,editable,movable,inlined,deletable,mutation,comment,next,data,inputs,fields) { return {_hx_index:0,type:type,id:id,disabled:disabled,collapsed:collapsed,editable:editable,movable:movable,inlined:inlined,deletable:deletable,mutation:mutation,comment:comment,next:next,data:data,inputs:inputs,fields:fields,__enum__:"blockly.model.BlockModel",toString:$estr}; },$_.__params__ = ["type","id","disabled","collapsed","editable","movable","inlined","deletable","mutation","comment","next","data","inputs","fields"],$_)
	,BlockType: ($_=function(type) { return {_hx_index:1,type:type,__enum__:"blockly.model.BlockModel",toString:$estr}; },$_.__params__ = ["type"],$_)
	,BlockMin: ($_=function(type,inputs,fields) { return {_hx_index:2,type:type,inputs:inputs,fields:fields,__enum__:"blockly.model.BlockModel",toString:$estr}; },$_.__params__ = ["type","inputs","fields"],$_)
};
var blockly_model_InputModel = $hxEnums["blockly.model.InputModel"] = { __ename__ : "blockly.model.InputModel", __constructs__ : ["ValueInput","Statement"]
	,ValueInput: ($_=function(name,block,shadow) { return {_hx_index:0,name:name,block:block,shadow:shadow,__enum__:"blockly.model.InputModel",toString:$estr}; },$_.__params__ = ["name","block","shadow"],$_)
	,Statement: ($_=function(name,block) { return {_hx_index:1,name:name,block:block,__enum__:"blockly.model.InputModel",toString:$estr}; },$_.__params__ = ["name","block"],$_)
};
...
app_blocks_KitchenSink.prototype = $extend(blockly_CustomBlock.prototype,{
	...
	,randomMenu: function() {
		...
		opts.push([opt,opt]);
		var opt1 = "# " + Math.round(Math.random() * 1000);
		opts.push([opt1,opt1]);
		var opt2 = "# " + Math.round(Math.random() * 1000);
		opts.push([opt2,opt2]);
		var opt3 = "# " + Math.round(Math.random() * 1000);
		opts.push([opt3,opt3]);
		var opt4 = "# " + Math.round(Math.random() * 1000);
		opts.push([opt4,opt4]);
		console.log("src/app/blocks/KitchenSink.hx:107:",opts);
		return opts;
	}
...
blockly_BlocklyApp.prototype = {
	...
	,registerBlock: function(clazz) {
		var blocklyApp = this;
		Blockly.Blocks[clazz.__name__] = { init : function() {
...
var blockly_events_Event = $hxEnums["blockly.events.Event"] = { __ename__ : "blockly.events.Event", __constructs__ : ["Change","Create","Delete","Move","UI","Unknown"]
	,Change: ($_=function(event) { return {_hx_index:0,event:event,__enum__:"blockly.events.Event",toString:$estr}; },$_.__params__ = ["event"],$_)
	,Create: ($_=function(event) { return {_hx_index:1,event:event,__enum__:"blockly.events.Event",toString:$estr}; },$_.__params__ = ["event"],$_)
	,Delete: ($_=function(event) { return {_hx_index:2,event:event,__enum__:"blockly.events.Event",toString:$estr}; },$_.__params__ = ["event"],$_)
	,Move: ($_=function(event) { return {_hx_index:3,event:event,__enum__:"blockly.events.Event",toString:$estr}; },$_.__params__ = ["event"],$_)
	,UI: ($_=function(event) { return {_hx_index:4,event:event,__enum__:"blockly.events.Event",toString:$estr}; },$_.__params__ = ["event"],$_)
	,Unknown: ($_=function(event) { return {_hx_index:5,event:event,__enum__:"blockly.events.Event",toString:$estr}; },$_.__params__ = ["event"],$_)
};
...
blockly_model_BlockBuilder.prototype = {
	build: function(def) {
		...
		case 0:
			var tooltip = _g4.tooltip;
			this.block.setTooltip(tooltip);
			break;
		case 1:
			var generator = _g4.generator;
	...
	,addInputs: function(inputs) {
		...
		while(_g < inputs.length) {
			...
			case 1:
				...
				var alignment1 = input.alignment;
				...
				break;
			case 2:
				var fields1 = input.fields;
				var alignment2 = input.alignment;
				var type = input.type;
				...
				break;
			case 3:
				var fields2 = input.fields;
				var alignment3 = input.alignment;
				var type1 = input.type;
				var name2 = input.name;
	...
	,createField: function(field) {
		...
		case 2:
			var text2 = field.text;
			var name = field.name;
			return { name : name, field : new Blockly.FieldTextInput(text2)};
		case 3:
			var text3 = field.text;
			var name1 = field.name;
...
var blockly_model_Tooltip = $hxEnums["blockly.model.Tooltip"] = { __ename__ : "blockly.model.Tooltip", __constructs__ : ["Fixed","Computed"]
	,Fixed: ($_=function(tooltip) { return {_hx_index:0,tooltip:tooltip,__enum__:"blockly.model.Tooltip",toString:$estr}; },$_.__params__ = ["tooltip"],$_)
	,Computed: ($_=function(generator) { return {_hx_index:1,generator:generator,__enum__:"blockly.model.Tooltip",toString:$estr}; },$_.__params__ = ["generator"],$_)
};
var blockly_model_Validator = $hxEnums["blockly.model.Validator"] = { __ename__ : "blockly.model.Validator", __constructs__ : ["Callback","Clear"]
	,Callback: ($_=function(fieldName,callback) { return {_hx_index:0,fieldName:fieldName,callback:callback,__enum__:"blockly.model.Validator",toString:$estr}; },$_.__params__ = ["fieldName","callback"],$_)
	,Clear: ($_=function(fieldName) { return {_hx_index:1,fieldName:fieldName,__enum__:"blockly.model.Validator",toString:$estr}; },$_.__params__ = ["fieldName"],$_)
};
var blockly_model_BlockColour = $hxEnums["blockly.model.BlockColour"] = { __ename__ : "blockly.model.BlockColour", __constructs__ : ["HSVColour","RGBColour"]
	,HSVColour: ($_=function(value) { return {_hx_index:0,value:value,__enum__:"blockly.model.BlockColour",toString:$estr}; },$_.__params__ = ["value"],$_)
	,RGBColour: ($_=function(value) { return {_hx_index:1,value:value,__enum__:"blockly.model.BlockColour",toString:$estr}; },$_.__params__ = ["value"],$_)
};
var blockly_model_Inlining = $hxEnums["blockly.model.Inlining"] = { __ename__ : "blockly.model.Inlining", __constructs__ : ["Automatic","External","Internal"]
	,Automatic: {_hx_index:0,__enum__:"blockly.model.Inlining",toString:$estr}
	,External: {_hx_index:1,__enum__:"blockly.model.Inlining",toString:$estr}
	,Internal: {_hx_index:2,__enum__:"blockly.model.Inlining",toString:$estr}
};
var blockly_model_InputDef = $hxEnums["blockly.model.InputDef"] = { __ename__ : "blockly.model.InputDef", __constructs__ : ["Dummy","LabelledField","Value","Statement"]
	,Dummy: ($_=function(name,alignment,fields) { return {_hx_index:0,name:name,alignment:alignment,fields:fields,__enum__:"blockly.model.InputDef",toString:$estr}; },$_.__params__ = ["name","alignment","fields"],$_)
	,LabelledField: ($_=function(label,alignment,field) { return {_hx_index:1,label:label,alignment:alignment,field:field,__enum__:"blockly.model.InputDef",toString:$estr}; },$_.__params__ = ["label","alignment","field"],$_)
	,Value: ($_=function(name,type,alignment,fields) { return {_hx_index:2,name:name,type:type,alignment:alignment,fields:fields,__enum__:"blockly.model.InputDef",toString:$estr}; },$_.__params__ = ["name","type","alignment","fields"],$_)
	,Statement: ($_=function(name,type,alignment,fields) { return {_hx_index:3,name:name,type:type,alignment:alignment,fields:fields,__enum__:"blockly.model.InputDef",toString:$estr}; },$_.__params__ = ["name","type","alignment","fields"],$_)
};
var blockly_model_FieldDef = $hxEnums["blockly.model.FieldDef"] = { __ename__ : "blockly.model.FieldDef", __constructs__ : ["TextLabel","StyledLabel","TextInput","SpellcheckedTextInput","Angle","DropDown","DropDownGen","Colour","CustomColours","CheckBox","Variable","Image","Numeric","DateSelect"]
	,TextLabel: ($_=function(text) { return {_hx_index:0,text:text,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["text"],$_)
	,StyledLabel: ($_=function(text,cssClass) { return {_hx_index:1,text:text,cssClass:cssClass,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["text","cssClass"],$_)
	,TextInput: ($_=function(name,text) { return {_hx_index:2,name:name,text:text,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","text"],$_)
	,SpellcheckedTextInput: ($_=function(name,text) { return {_hx_index:3,name:name,text:text,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","text"],$_)
	,Angle: ($_=function(name,value) { return {_hx_index:4,name:name,value:value,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","value"],$_)
	,DropDown: ($_=function(name,value,options) { return {_hx_index:5,name:name,value:value,options:options,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","value","options"],$_)
	,DropDownGen: ($_=function(name,value,generator) { return {_hx_index:6,name:name,value:value,generator:generator,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","value","generator"],$_)
	,Colour: ($_=function(name,value) { return {_hx_index:7,name:name,value:value,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","value"],$_)
	,CustomColours: ($_=function(name,value,cols,colours) { return {_hx_index:8,name:name,value:value,cols:cols,colours:colours,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","value","cols","colours"],$_)
	,CheckBox: ($_=function(name,value) { return {_hx_index:9,name:name,value:value,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","value"],$_)
	,Variable: ($_=function(name,value) { return {_hx_index:10,name:name,value:value,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","value"],$_)
	,Image: ($_=function(url,w,h,alt) { return {_hx_index:11,url:url,w:w,h:h,alt:alt,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["url","w","h","alt"],$_)
	,Numeric: ($_=function(name,value,min,max,precision) { return {_hx_index:12,name:name,value:value,min:min,max:max,precision:precision,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","value","min","max","precision"],$_)
	,DateSelect: ($_=function(name,date) { return {_hx_index:13,name:name,date:date,__enum__:"blockly.model.FieldDef",toString:$estr}; },$_.__params__ = ["name","date"],$_)
};
var blockly_model_ValueType = $hxEnums["blockly.model.ValueType"] = { __ename__ : "blockly.model.ValueType", __constructs__ : ["AnyType","BoolType","NumType","StringType","ListType","UnionType","CustomType"]
	,AnyType: {_hx_index:0,__enum__:"blockly.model.ValueType",toString:$estr}
	,BoolType: {_hx_index:1,__enum__:"blockly.model.ValueType",toString:$estr}
	,NumType: {_hx_index:2,__enum__:"blockly.model.ValueType",toString:$estr}
	,StringType: {_hx_index:3,__enum__:"blockly.model.ValueType",toString:$estr}
	,ListType: {_hx_index:4,__enum__:"blockly.model.ValueType",toString:$estr}
	,UnionType: ($_=function(types) { return {_hx_index:5,types:types,__enum__:"blockly.model.ValueType",toString:$estr}; },$_.__params__ = ["types"],$_)
	,CustomType: ($_=function(name) { return {_hx_index:6,name:name,__enum__:"blockly.model.ValueType",toString:$estr}; },$_.__params__ = ["name"],$_)
};
var blockly_model_FieldAlignment = $hxEnums["blockly.model.FieldAlignment"] = { __ename__ : "blockly.model.FieldAlignment", __constructs__ : ["Left","Right","Center"]
	,Left: {_hx_index:0,__enum__:"blockly.model.FieldAlignment",toString:$estr}
	,Right: {_hx_index:1,__enum__:"blockly.model.FieldAlignment",toString:$estr}
	,Center: {_hx_index:2,__enum__:"blockly.model.FieldAlignment",toString:$estr}
};
...
blockly_model_ToolboxS12.serialize = function(toolbox) {
	...
	switch(toolbox._hx_index) {
	case 0:
		var items = toolbox.items;
		var _g = 0;
...
blockly_model_ToolboxS12.serializeBlocks = function(block) {
	...
	case 0:
		var b = block.block;
		return blockly_model_WorkspaceS12.serializeBlock(b);
	case 1:
		var text = block.text;
...
blockly_model_WorkspaceS12.serializeBlock = function(block,isShadow) {
	...
	case 0:
		...
		var deletable = block.deletable;
		var inlined = block.inlined;
		var movable = block.movable;
		var editable = block.editable;
		var collapsed = block.collapsed;
		var disabled = block.disabled;
		var id = block.id;
		var type = block.type;
	...
	case 2:
		var fields1 = block.fields;
		var inputs1 = block.inputs;
		var type2 = block.type;
