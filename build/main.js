...
app_Main.prototype = {
	workspaceChanged: function(event) {
		...
		this.resultArea.innerText = "" + Std.string(blockly_model_WorkspaceS12.deserializeWorkspace(_this.children[0]));
	}
	,__class__: app_Main
};
...
var blockly_events_Event = { __ename__ : true, __constructs__ : ["Change","Create","Delete","Move","UI","Unknown"] };
...
var blockly_model_Tooltip = { __ename__ : true, __constructs__ : ["Fixed","Computed"] };
...
var blockly_model_FieldDef = { __ename__ : true, __constructs__ : ["TextLabel","StyledLabel","TextInput","SpellcheckedTextInput","Angle","DropDown","DropDownGen","Colour","CustomColours","CheckBox","Variable","Image","Numeric","DateSelect"] };
...
var blockly_model_InputModel = { __ename__ : true, __constructs__ : ["ValueInput","Statement"] };
...
blockly_model_WorkspaceS12.deserializeBlock = function(xml) {
	return { type : xml.get("type"), id : xml.get("id"), disabled : blockly_model_WorkspaceS12.boolAttrTrue(xml,"disabled"), collapsed : blockly_model_WorkspaceS12.boolAttrTrue(xml,"collapsed"), mutation : blockly_model_WorkspaceS12.elemNamed(xml,"mutation"), editable : blockly_model_WorkspaceS12.boolAttrTrue(xml,"editable"), movable : blockly_model_WorkspaceS12.boolAttrTrue(xml,"movable"), inlined : blockly_model_WorkspaceS12.boolAttrTrue(xml,"inline"), deletable : blockly_model_WorkspaceS12.boolAttrTrue(xml,"deletable"), comment : blockly_model_WorkspaceS12.getComment(xml), next : blockly_model_WorkspaceS12.getNext(xml), data : blockly_model_WorkspaceS12.textNamed(xml,"data"), inputs : null, fields : blockly_model_WorkspaceS12.readFields(xml)};
};
...
blockly_model_WorkspaceS12.getComment = function(xml) {
	...
	return { text : blockly_model_WorkspaceS12.elemText(elem), pinned : blockly_model_WorkspaceS12.boolAttrTrue(elem,"pinned"), w : blockly_model_WorkspaceS12.intAttr(elem,"w"), h : blockly_model_WorkspaceS12.intAttr(elem,"h")};
};
blockly_model_WorkspaceS12.boolAttrTrue = function(xml,attr) {
